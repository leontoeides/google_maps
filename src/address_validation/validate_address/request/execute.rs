impl crate::address_validation::validate_address::Request<'_> {
    /// Executes the Google Maps Address Validation API validate address
    /// request.
    ///
    /// ## Description
    ///
    ...
    pub async fn execute(
        self
    ) -> Result<crate::address_validation::validate_address::Response, crate::Error> {
        self.client.post_request(self).await
    } // fn
} // impl