...
//! route, and returns a similar set of data with the points snapped to the most
//! likely roads the vehicle was traveling along. Optionally, you can request
//! that the points be interpolated, resulting in a path that smoothly follows
