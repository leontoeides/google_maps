...
/// and rating-limiting.
impl crate::traits::EndPoint for crate::places::place_details::Request<'_> {
    fn service_url() -> &'static str { "https://maps.googleapis.com/maps/api/place/details" }
    #[cfg(feature = "reqwest")]
    fn title() -> &'static str { "Places API Place Details" }
    #[cfg(feature = "reqwest")]
