...
/// and rating-limiting.
impl crate::traits::EndPoint for crate::places::place_autocomplete::Request<'_> {
    fn service_url() -> &'static str { "https://maps.googleapis.com/maps/api/place/autocomplete" }
    #[cfg(feature = "reqwest")]
    fn title() -> &'static str { "Places API Place Autocomplete" }
    #[cfg(feature = "reqwest")]
