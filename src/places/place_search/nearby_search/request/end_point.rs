...
/// and rating-limiting.
impl crate::traits::EndPoint for crate::places::place_search::nearby_search::Request<'_> {
    fn service_url() -> &'static str { "https://maps.googleapis.com/maps/api/place/nearbysearch" }
    #[cfg(feature = "reqwest")]
    fn title() -> &'static str { "Places API Nearby Search" }
    #[cfg(feature = "reqwest")]
