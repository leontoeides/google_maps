...
impl TryFrom<&Rect> for Bounds {
    ...
    /// Attempts to convert a `geo_types::geometry::Rect` struct to a
    ...
    fn try_from(rect: &Rect) -> Result<Self, Self::Error> {
        ...
        let southwest: LatLng = LatLng::try_from_dec(sw_lat, sw_lng)?;
        ...
        let northeast: LatLng = LatLng::try_from_dec(ne_lat, ne_lng)?;
