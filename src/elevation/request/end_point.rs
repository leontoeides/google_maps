...
/// and rating-limiting.
impl crate::traits::EndPoint for crate::elevation::Request<'_> {
    fn service_url() -> &'static str { "https://maps.googleapis.com/maps/api/elevation" }
    #[cfg(feature = "reqwest")]
    fn title() -> &'static str { "Elevation API" }
    #[cfg(feature = "reqwest")]
    fn apis() -> &'static [Api] { &[Api::All, Api::Elevation] }
} // impl